...
public class OrdenamientoTest {
  ...
  @Test
  public void deberiaOrdenarElementos() {
    List<Integer> elementosDesordenados = new ArrayList<Integer>();
    ...
    List<Integer> listaDeElementosEsperados = new ArrayList<Integer>();
